...
{ 
    ...
    Import-DscResource -ModuleName @{modulename="Azure.Storage";moduleversion="2.8.0"}
...
#########################Package copy and installation#########################                
        ...
        {
            setScript ={wget -UseBasicParsing -Method Get 'https://reieast2storage.file.core.windows.net/ise/prerequisites/SQLServer2012_PerformanceDashboard.msi?sv=2016-05-31&ss=bfqt&srt=sco&sp=rwdlacup&se=2017-05-01T21:21:19Z&st=2017-05-01T13:21:19Z&spr=https&sig=0RrgQjH70UmWKaCZROhiNjHJWCwpd9u7hjrU1WqvLkg%3D' -OutFile 'c:\rburke\SQLServer2012_PerformanceDashboard.msi'}
        ...
        {
            setScript ={wget -UseBasicParsing -Method Get 'https://reieast2storage.file.core.windows.net/ise/prerequisites/7z920-x64.msi?sv=2016-05-31&ss=bfqt&srt=sco&sp=rwdlacup&se=2017-05-01T21:21:19Z&st=2017-05-01T13:21:19Z&spr=https&sig=0RrgQjH70UmWKaCZROhiNjHJWCwpd9u7hjrU1WqvLkg%3D' -OutFile 'c:\rburke\7z920-x64.msi'}
        ...
        script WSE2SP3Copy
        {
            setScript ={wget -UseBasicParsing -Method Get 'https://reieast2storage.file.core.windows.net/ise/prerequisites/WSE 2.0 SP3 Runtime.msi?sv=2016-05-31&ss=bfqt&srt=sco&sp=rwdlacup&se=2017-05-01T21:21:19Z&st=2017-05-01T13:21:19Z&spr=https&sig=0RrgQjH70UmWKaCZROhiNjHJWCwpd9u7hjrU1WqvLkg%3D' -OutFile 'c:\rburke\WSE 2.0 SP3 Runtime.msi'}
        ...
        File ehbepsdircreate
        {
            Ensure = 'Present'
            Type = 'Directory'
            DestinationPath = 'c:\hrsa\ehbeps'
        }
        
        script ehbmapdrive
        {
            setScript ={Invoke-Command -ComputerName 'localhost' -ScriptBlock {"net use L: \\reieast2storage.file.core.windows.net\hrsa /u:AZURE\reieast2storage 45hXlxP2FcEK1HCTz9Pjx4RlU7VTVUH4AZ8mCNb8nxaZ13sSORG4qN9uODKzCRV4vCeVO7XEshr6Bv5eii2Ncw=="}}
            TestScript = "Test-Path -path 'l:\ehbeps'"
            Getscript = {@(pathtest = (Test-Path -Path "l:\ehbeps"))}
        }
        File ehbepsCopy
        {
            Ensure = 'Present'
...
<#
IISInstall2 -ConfigurationData $test -OutputPath 'd:\rburke\is'
