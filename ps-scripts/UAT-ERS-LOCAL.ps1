    ...
    $verifyCredential = (Get-Credential -UserName "" -message "Enter your domain account reisys\yourID" )
     Node "localhost"
     #$AllNodes.Where{$_.Config -eq "ERS"}.NodeName
    {
    <#
        $gemsapppw = $Node.gemsapppassword | convertto-securestring -AsPlainText -Force
        $gemsapp = new-object -typename System.Management.Automation.PSCredential -argumentlist gemsapp,$gemsapppw  
        $ehbssaspw = $Node.gemsapppassword | convertto-securestring -AsPlainText -Force
        $ehbssas = new-object -typename System.Management.Automation.PSCredential -argumentlist gemsapp,$ehbssaspw 
        $domaincredpw = $Node.DomainCredPassword | convertto-securestring -AsPlainText -Force
        $domaincred = new-object -typename System.Management.Automation.PSCredential -argumentlist $Node.DomainCred,$domaincredpw 
        #>
       User gemsapp 
       {
            Ensure = 'Present'
    ...
    #GemsUser1
       ...
       GroupName = 'Administrators'
        MembersToInclude = 'gemsapp','ehbssas', 'reisys\hrsa-cm','reisys\HRSA-DBA'
       ...
       WindowsFeature ASHTTPActivation
       {
        ...
        {
         Setscript ={
         $reportviewer2008 = "\\hrsafs\ise\Prerequisites\ReportViewer2008SP1.exe /q"
         Invoke-expression $reportviewer2008
        }
         TestScript = "Test-Path -path 'C:\Windows\System32\msxml6.dll'"
         Getscript = {@(pathtest = (Test-Path -Path "C:\Windows\System32\msxml4.dll"))}
        }
         ...
         File F5XForwardedFor 
        {
            ...
            Type = "Directory"
            Recurse = $true
            SourcePath = '\\hrsafs\ise\Prerequisites\IIS_Rewrite_86\IIS_Rewrite'
       ...
       Environment REIConfigLocationHRSA
        ...
        UatERSConfig -ConfigurationData $test -OutputPath 'Y:\rburke\uat\ers'
        #Start-DscConfiguration -Path 'Y:\rburke\uat\ers' -Wait -Force -Verbose