...
#>
       ...
       {       
            ...
            Source = "\\ehb-perf-p1\ise\2012r2_Source\sxs"
       }
       ...
       WindowsFeature ASHTTPActivation
       {
        ...
        Package SQL2012Dashboard
        {
            ...
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\SQLServer2012_PerformanceDashboard.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\msxml_SP3.msi"
        ...
        {
         Setscript ={
         $msxml6x64 = "msiexec /i \\ehb-perf-p1\ise\Prerequisites\msxml6_x64.msi /quiet"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\WSE 2.0 SP3 Runtime.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\WSE 3.0.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\sqlxml_x64.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\SQLServer2005_ASOLEDB9_x64.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\SQL_AS_OLEDB.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\SQL_AS_ADOMD.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "\\ehb-perf-p1\ISE\Prerequisites\ASPAJAXExtSetup.msi"
        ...
        Package AccessDatabaseEngine
        {
            ...
            Path = "\\ehb-perf-p1\ISE\Prerequisites\AccessDatabaseEngine_x64.exe"
        ...
        Package OfficeWebComponents
        {
            ...
            Path = "\\ehb-perf-p1\ise\Prerequisites\owc11.exe"
            ...
            Package ReportViewer2005
         {
            ...
            Path = '\\ehb-perf-p1\ISE\Prerequisites\reportviewer2005\install.exe'
        ...
        {
         Setscript ={
         $reportviewer2008 = "\\ehb-perf-p1\ise\Prerequisites\ReportViewer2008SP1.exe /Q"
        ...
        File RootCopy
        {
            ...
            Type = 'Directory'
            Recurse = $true
            SourcePath = '\\ehb-perf-p1\ISE\Prerequisites\Root'
        ...
        {
            Type = "File"
            DestinationPath = "\\ehb-perf-p1\ise\Tools\ntrights.exe"
            Ensure = "Present"
        }
        File SAFileUpcheck 
        {
            ...
            Type = "Directory"
            Recurse = $true
            SourcePath = "\\ehb-perf-p1\ise\Prerequisites\SAFileUp_5.3.2.68"
         ...
         File F5XForwardedFor 
        {
            ...
            Type = "Directory"
            Recurse = $true
            SourcePath = '\\ehb-perf-p1\ise\Prerequisites\IIS_Rewrite_64\IIS_Rewrite'
       ...
       #######Registry Edits      
        ...
        {
         Setscript ={
         $ntrights = "\\ehb-perf-p1\ise\Tools\ntrights.exe"
         $machine = $Env:computerName
         Invoke-expression ("$ntrights -u gemsapp +r SeServiceLogonRight -m \\$machine")
        }
         TestScript = "Test-Path -path '\\ehb-perf-p1\ise\Tools\mytest.exe'"
      ...
      PRODISConfig -ConfigurationData $test -OutputPath 'y:\rburke\is'
