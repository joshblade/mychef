#Description: This is the DSC IS configuration script, it is currently setup to run as a locally executed push script

Configuration azuresbxconfig{
     ...
     
    {
       ...
       xTimeZone REI-EST
        ...
        Environment REIConfigLocationHRSA
        {
            ...
            Value = "\\GEMSFS1\ConfigurationData"
        }
       #######Services
       ...
       WindowsFeature ASHTTPActivation
       {
        ...
        Package SQL2012Dashboard
        {
            ...
            Path  = "https://reidevopsstorage.file.core.windows.net/ise/prerequisites/7z920-x64.msi/SQLServer2012_PerformanceDashboard.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/msxml_SP3.msi"
        ...
        {
         Setscript ={
         $msxml6x64 = "msiexec /i https://reidevopsstorage.file.core.windows.net/ise/prerequisites/7z920-x64.msi/msxml6_x64.msi /quiet"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/WSE 2.0 SP3 Runtime.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/WSE 3.0.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/sqlxml_x64.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/SQLServer2005_ASOLEDB9_x64.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/SQL_AS_OLEDB.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/SQL_AS_ADOMD.msi"
        ...
        {
            Ensure = "Present"  # You can also set Ensure to "Absent"
            Path  = "https://reidevopsstorage.blob.core.windows.net/prereqs/ASPAJAXExtSetup.msi"
        ...
        Package AccessDatabaseEngine
        {
            ...
            Path = "https://reidevopsstorage.blob.core.windows.net/prereqs/AccessDatabaseEngine_x64.exe"
        ...
        Package OfficeWebComponents
        {
            ...
            Path = "https://reidevopsstorage.blob.core.windows.net/prereqs/owc11.exe"
            ...
            Package ReportViewer2005
         {
            ...
            Path = 'https://reidevopsstorage.blob.core.windows.net/prereqs/reportviewer2005\install.exe'
        ...
        {
         Setscript ={
         $reportviewer2008 = "https://reidevopsstorage.blob.core.windows.net/prereqs/ReportViewer2008SP1.exe /Q"
        ...
        File RootCopy
        {
            ...
            Type = 'Directory'
            Recurse = $true
            SourcePath = 'https://reidevopsstorage.blob.core.windows.net/prereqs/Root'
        ...
        {
            Type = "File"
            DestinationPath = "https://reidevopsstorage.blob.core.windows.net/prereqs/Tools/ntrights.exe"
            Ensure = "Present"
        }
        File SAFileUpcheck 
        {
            ...
            Type = "Directory"
            Recurse = $true
            SourcePath = "https://reidevopsstorage.blob.core.windows.net/prereqs/SAFileUp_5.3.2.68"
         ...
         File F5XForwardedFor 
        {
            ...
            Type = "Directory"
            Recurse = $true
            SourcePath = 'https://reidevopsstorage.blob.core.windows.net/prereqs/IIS_Rewrite_64/IIS_Rewrite'
       ...
       #######Registry Edits      
        ...
        {
         Setscript ={
         $ntrights = "https://reidevopsstorage.blob.core.windows.net/prereqs/\Tools\ntrights.exe"
         $machine = $Env:computerName
         Invoke-expression ("$ntrights -u gemsapp +r SeServiceLogonRight -m \\$machine")
        }
         TestScript = "Test-Path -path 'https://reidevopsstorage.blob.core.windows.net/prereqs/\Tools\mytest.exe'"
        ...
        { 
            ...
            BindingInfo     = @( 
                             ...
                             {                            
                               Protocol              = "HTTPS" 
                               Port                  = "443"
                               CertificateThumbprint = "cb7112ff26575098a4d1de42fba3f6c8ffb5f910"
                               CertificateStoreName  = "Personal" 
                               }
                                );#>
                               @(REI_cWebBindingInformation 
                             {
      ...
      #azuresbxconfig -ConfigurationData $test -OutputPath 'y:\rburke\is'
