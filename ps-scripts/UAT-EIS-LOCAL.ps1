    ...
    $verifyCredential = (Get-Credential -UserName "" -message "Enter your domain account reisys\yourID" )
     Node "localhost"
     #$AllNodes.Where{$_.Config -eq "EIS"}.NodeName  
    {
    <#
       ...
       MembersToInclude = 'gemsapp','ehbssas','reisys\hrsa-cm','reisys\HRSA-DBA','eisuser'
       ...
       Environment REIConfigLocationHRSA
        ...
        UatEISConfig  -ConfigurationData $test -OutputPath 'Y:\rburke\uat\EIS'
        #Start-DscConfiguration -Path Y:\rburke\uat\eis -Wait -Force -Verbose